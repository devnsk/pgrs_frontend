...
const AdLayout = () => {
    ...
    const menuItems = [
         ...
         { text: "Departments", icon: <DepartmentsIcon />, path: "/admin/departments" },
         { text: "Roles", icon: <RolesIcon />, path: "/admin/role" },
         { text: "Complain Inbox", icon: <ComplainIcon />, path: "/admin/complain inbox" },
      ];
      useEffect(() => {
